...
const activities = [
  { title: "L'Aube Douce", medicalObjective: "Échauffement", patientPromise: "Pédalage léger au lever du soleil pour réveiller vos articulations.", duration: "15 min", intensityLevel: "Très Faible", targets: ["Lubrification articulaire", "Mise en route cardiovasculaire"], theme: "Nature", image: "/images/scen-matin.png", color: "#20C997" },
  { title: "L'Échappée Sylvestre", medicalObjective: "Coordination", patientPromise: "Adaptez votre cadence aux variations du terrain en forêt.", duration: "20 min", intensityLevel: "Modérée", targets: ["Coordination neuro-musculaire", "Équilibre et appuis sur pédales"], theme: "Forêt", image: "/images/scen-foret.png", color: "#00B8D9" },
  { title: "Souffle Océanique", medicalObjective: "Récupération", patientPromise: "Pédalez le long de la côte à rythme régulier.", duration: "10 min", intensityLevel: "Variable", targets: ["Drainage des toxines musculaires", "Régulation respiratoire"], theme: "Plage", image: "/images/scen-plage.png", color: "#0EA5E9" },
  { title: "Le Jardin des Sens", medicalObjective: "Cognitif", patientPromise: "Parcourez ce jardin coloré. Votre attention sera doucement sollicitée.", duration: "12 min", intensityLevel: "Faible", targets: ["Maintien de l'attention pendant l'effort", "Mémorisation visuelle"], theme: "Jardin", image: "/images/scen-jardin.png", color: "#38BDF8" },
  { title: "L'Ascension Alpine", medicalObjective: "Endurance", patientPromise: "Un défi stimulant en montagne pour faire travailler votre cœur.", duration: "25 min", intensityLevel: "Élevée", targets: ["Tolérance à l'effort lactique", "Augmentation de la capacité aérobie"], theme: "Montagne", image: "/images/scen-montagne.png", color: "#0284C7" },
...
const generateWeekSchedule = () => {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    schedule.push({
      name: daysLabels[i], dayNum: currentDay.getDate(), month: currentDay.toLocaleString('fr-FR', { month: 'short' }),
      isToday, prescribed, timeSlot, status, activity
    })
  }
...
const startGame = () => {
  ...
  router.push({ 
    path: '/play', 
    query: { avatar: selectedAvatar.value, theme: selectedActivity.value.title, equip: selectedEquip.value, from: 'patient' } 
  })
}
</script>
